...
- Redux DevTools by [redux-devtools](https://github.com/reduxjs/redux-devtools)
...
```sh
# clone it
  git clone https://github.com/caioorg/react-hook-with-redux-hooks
  cd react-hook-with-redux-hooks
